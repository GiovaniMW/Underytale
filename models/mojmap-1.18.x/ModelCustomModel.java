	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(6, 3)
						.addBox(0.0F, -1.5F, -2.0F, 0.0F, 0.0F, 0.0F, new CubeDeformation(0.5F)).texOffs(1, 4)
						...
						.addBox(-0.5F, -2.0F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.1F)).texOffs(2, 4)
						.addBox(-0.5F, -2.0F, -1.8F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.1F)),
